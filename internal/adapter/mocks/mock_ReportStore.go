...
// MockReportStore_LoadSpillReports_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LoadSpillReports'
type MockReportStore_LoadSpillReports_Call struct {
	*mock.Call
}
...
func (_c *MockReportStore_LoadSpillReports_Call) Return(_a0 pkg.FileSpill[model.Report], _a1 error) *MockReportStore_LoadSpillReports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// MockReportStore_SaveSpillReports_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveSpillReports'
type MockReportStore_SaveSpillReports_Call struct {
	*mock.Call
}
...
func (_c *MockReportStore_SaveSpillReports_Call) Return(_a0 error) *MockReportStore_SaveSpillReports_Call {
	_c.Call.Return(_a0)
	return _c
}
